...
namespace iPlay
{
	...
	{
		private UI.VLC vlc;
		private UI.Slider sliderVideoProgress;
		public VideoForm() : base(500, 500)
		{
			...
			sliderVideoProgress = new UI.Slider(new UI.Rect2D { X = 5, Y = this.uiContainer.Rect.H - this.uiContainer.Rect.Y, W = this.uiContainer.Rect.W - 10, H = 7 }, "Slider1", UI.Slider.SliderOrientation.Horizontal);
		...
		{
			this.vlcControl1.Position = ((UI.Slider)sender).Value;
		}

		private void timer1_Tick(object sender, EventArgs e)
		{
			sliderVideoProgress.Value = vlcControl1.Position;
			this.Refresh();
		}
